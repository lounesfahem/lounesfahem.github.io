        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://linkedin.com/in/lounes-fahem" target="_blank" className="flex items-center space-x-2 px-6 py-3 bg-slate-800 hover:bg-slate-700 rounded-xl transition-all">
                <Linkedin className="w-5 h-5 text-blue-400" />
                <span>LinkedIn</span>
              </a>
              <a href="https://github.com/lounesfahem" target="_blank" className="flex items-center space-x-2 px-6 py-3 bg-slate-800 hover:bg-slate-700 rounded-xl transition-all">
